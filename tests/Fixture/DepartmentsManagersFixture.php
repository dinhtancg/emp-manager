...
class DepartmentsManagersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'departments_managers_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'departments_managers_ibfk_2' => ['type' => 'foreign', 'columns' => ['department_id'], 'references' => ['departments', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'department_id' => 1,
            'created' => '2017-07-19 09:33:40',
            'modified' => '2017-07-19 09:33:40'
        ],
    ];
}
